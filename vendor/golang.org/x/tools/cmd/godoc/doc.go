...
a command with the same name exists, using the prefix main/ will force
...
source form, or the implementation of a specific exported language entity:
	...
	godoc main/go             # force documentation for the go command
...
*/
package main // import "golang.org/x/tools/main/godoc"
