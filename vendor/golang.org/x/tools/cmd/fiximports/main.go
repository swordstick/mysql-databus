...
For details, see http://godoc.org/golang.org/x/tools/main/fiximports.
...
// listPackage is a copy of main/go/list.Package.
...
// Plundered from $GOROOT/src/main/go/build.go.
