...
// Example
//
// Bundle archive/zip for inclusion in main/dist:
//
//	cd $GOROOT/src/main/dist
...
//
//	go generate -run bundle main/dist net/http
//
package main
...
// isStandardImportPath is copied from main/go in the standard library.
...
func bundle(src, dst, dstpkg, prefix string) ([]byte, error) {
	...
	fmt.Fprintf(&out, "// Code generated by golang.org/x/tools/main/bundle. DO NOT EDIT.\n")
	if *outputFile != "" {
