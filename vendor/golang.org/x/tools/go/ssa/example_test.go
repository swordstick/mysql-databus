...
// golang.org/x/tools/main/ssadump.
//
...
// This program shows how to load a main package (main/cover) and all its
...
func ExampleLoadProgram() {
	// Load main/cover and its dependencies.
	var conf loader.Config
	conf.Import("main/cover")
	lprog, err := conf.Load()
	if err != nil {
		fmt.Print(err) // type error in some package
		return
	...
	// Build SSA code for the entire main/cover program.
	prog.Build()
